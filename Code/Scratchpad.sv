...
module Scratchpad(
  ...
  input  [2:0]   auto_id_out_d_bits_sink,
  input          auto_id_out_d_bits_denied,
  input  [63:0]  auto_id_out_d_bits_data,
  ...
  output [7:0]   auto_id_out_a_bits_mask,
  output [63:0]  auto_id_out_a_bits_data,
  ...
  wire [2:0]   _buffer_2_auto_in_d_bits_sink;	// @[Buffer.scala:69:28]
  ...
  wire [3:0]   _buffer_2_auto_out_a_bits_size;	// @[Buffer.scala:69:28]
  wire [4:0]   _buffer_2_auto_out_a_bits_source;	// @[Buffer.scala:69:28]
  wire [31:0]  _buffer_2_auto_out_a_bits_address;	// @[Buffer.scala:69:28]
  wire [15:0]  _buffer_2_auto_out_a_bits_mask;	// @[Buffer.scala:69:28]
  wire [127:0] _buffer_2_auto_out_a_bits_data;	// @[Buffer.scala:69:28]
  wire         _buffer_2_auto_out_a_bits_corrupt;	// @[Buffer.scala:69:28]
  ...
  wire [1:0]   _widget_auto_in_d_bits_param;	// @[WidthWidget.scala:220:28]
  wire [3:0]   _widget_auto_in_d_bits_size;	// @[WidthWidget.scala:220:28]
  wire [4:0]   _widget_auto_in_d_bits_source;	// @[WidthWidget.scala:220:28]
  wire [2:0]   _widget_auto_in_d_bits_sink;	// @[WidthWidget.scala:220:28]
  ...
  wire [2:0]   _xbar_auto_in_1_d_bits_sink;	// @[Xbar.scala:144:26]
  ...
  wire [2:0]   _xbar_auto_in_0_d_bits_sink;	// @[Xbar.scala:144:26]
  ...
  TLWidthWidget_11 widget (	// @[WidthWidget.scala:220:28]
    .clock                   (clock),
    .reset                   (reset),
    .auto_in_a_valid         (_buffer_2_auto_out_a_valid),	// @[Buffer.scala:69:28]
    .auto_in_a_bits_opcode   (_buffer_2_auto_out_a_bits_opcode),	// @[Buffer.scala:69:28]
    .auto_in_a_bits_param    (_buffer_2_auto_out_a_bits_param),	// @[Buffer.scala:69:28]
    .auto_in_a_bits_size     (_buffer_2_auto_out_a_bits_size),	// @[Buffer.scala:69:28]
    .auto_in_a_bits_source   (_buffer_2_auto_out_a_bits_source),	// @[Buffer.scala:69:28]
    .auto_in_a_bits_address  (_buffer_2_auto_out_a_bits_address),	// @[Buffer.scala:69:28]
    .auto_in_a_bits_mask     (_buffer_2_auto_out_a_bits_mask),	// @[Buffer.scala:69:28]
    .auto_in_a_bits_data     (_buffer_2_auto_out_a_bits_data),	// @[Buffer.scala:69:28]
    .auto_in_a_bits_corrupt  (_buffer_2_auto_out_a_bits_corrupt),	// @[Buffer.scala:69:28]
    .auto_in_d_ready         (_buffer_2_auto_out_d_ready),	// @[Buffer.scala:69:28]
  ...
  TLBuffer_19 buffer_2 (	// @[Buffer.scala:69:28]
    ...
    .auto_out_d_bits_param   (_widget_auto_in_d_bits_param),	// @[WidthWidget.scala:220:28]
    ...
    .auto_out_d_bits_sink    (_widget_auto_in_d_bits_sink),	// @[WidthWidget.scala:220:28]
  ...
  Queue_49 write_dispatch_q (	// @[Decoupled.scala:375:21]
    .clock                               (clock),
    .reset                               (reset),
  ...
  Queue_50 write_norm_q (	// @[Scratchpad.scala:252:30]
    .clock                               (clock),
    .reset                               (reset),
  ...
  Queue_50 write_scale_q (	// @[Scratchpad.scala:253:31]
    .clock                               (clock),
    .reset                               (reset),
  ...
  Queue_52 write_issue_q (	// @[Scratchpad.scala:254:31]
    .clock                               (clock),
    .reset                               (reset),
  ...
  Queue_53 read_issue_q (	// @[Scratchpad.scala:255:30]
    .clock                               (clock),
    .reset                               (reset),
  ...
  Queue_58 norm_unit_passthru_q (	// @[Normalizer.scala:621:38]
    .clock                                   (clock),
    .reset                                   (reset),
