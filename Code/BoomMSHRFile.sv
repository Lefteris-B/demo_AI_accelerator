...
module BoomMSHRFile(
  ...
  wire        earlyWinner_2 = ~_GEN_0 & _mmios_0_io_mem_access_valid;	// @[Arbiter.scala:16:61, :97:79, mshrs.scala:710:22, package.scala:245:43]
  ...
  wire        out_3_valid = idle ? _sink_ACancel_earlyValid_T | _mmios_0_io_mem_access_valid : state_0 & _mshrs_0_io_mem_acquire_valid | state_1 & _mshrs_1_io_mem_acquire_valid | state_2 & _mmios_0_io_mem_access_valid;	// @[Arbiter.scala:88:28, :107:36, :116:26, :125:{29,56}, Mux.scala:27:73, mshrs.scala:620:22, :710:22]
  ...
  wire        _sink_ACancel_earlyValid_T_8 = _mshrs_0_io_mem_finish_valid | _mshrs_1_io_mem_finish_valid;	// @[Arbiter.scala:107:36, mshrs.scala:620:22]
  reg         state_1_0;	// @[Arbiter.scala:116:26]
  reg         state_1_1;	// @[Arbiter.scala:116:26]
  wire        out_6_valid = beatsLeft_1 ? state_1_0 & _mshrs_0_io_mem_finish_valid | state_1_1 & _mshrs_1_io_mem_finish_valid : _sink_ACancel_earlyValid_T_8;	// @[Arbiter.scala:87:30, :107:36, :116:26, :125:29, Mux.scala:27:73, mshrs.scala:620:22]
  ...
  wire        winnerQual_2 = ~_GEN_0 & _mmios_0_io_mem_access_valid;	// @[Arbiter.scala:16:61, :98:79, mshrs.scala:710:22, package.scala:245:43]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (idle & io_mem_acquire_ready) begin	// @[Arbiter.scala:88:28, :89:24]
        if (winnerQual_2 & ~(_mmios_0_io_mem_access_bits_opcode[2]))	// @[Arbiter.scala:98:79, :111:73, Edges.scala:91:{28,37}, :220:14, mshrs.scala:710:22]
          beatsLeft <= ~(_decode_T_9[11:3]);	// @[Arbiter.scala:87:30, package.scala:235:{46,71,76}]
        else	// @[Arbiter.scala:111:73, Edges.scala:220:14]
          beatsLeft <= 9'h0;	// @[Arbiter.scala:87:30, :112:44]
      end
      else	// @[Arbiter.scala:89:24]
        beatsLeft <= beatsLeft - {8'h0, io_mem_acquire_ready & out_3_valid};	// @[Arbiter.scala:87:30, :113:52, :125:29, Mux.scala:27:73, ReadyValidCancel.scala:49:33]
      ...
      beatsLeft_1 <= ~(~beatsLeft_1 & io_mem_finish_ready) & beatsLeft_1 - (io_mem_finish_ready & out_6_valid);	// @[Arbiter.scala:87:30, :88:28, :89:24, :113:{23,52}, :125:29, ReadyValidCancel.scala:49:33]
  ...
  `ifndef SYNTHESIS
    wire         _T_50 = _mshrs_0_io_mem_acquire_valid | _mshrs_1_io_mem_acquire_valid;	// @[Arbiter.scala:108:36, mshrs.scala:620:22]
    always @(posedge clock) begin	// @[Arbiter.scala:105:13]
      if (~reset & ~((~_mshrs_0_io_mem_acquire_valid | ~earlyWinner_1) & (~(_mshrs_0_io_mem_acquire_valid | earlyWinner_1) | ~earlyWinner_2))) begin	// @[Arbiter.scala:97:79, :104:53, :105:{13,61,64,67,82}, mshrs.scala:620:22]
        if (`ASSERT_VERBOSE_COND_)	// @[Arbiter.scala:105:13]
          $error("Assertion failed\n    at Arbiter.scala:105 assert((prefixOR zip earlyWinner) map { case (p,w) => !p || !w } reduce {_ && _})\n");	// @[Arbiter.scala:105:13]
        if (`STOP_COND_)	// @[Arbiter.scala:105:13]
          $fatal;	// @[Arbiter.scala:105:13]
      end
      if (~reset & ~(~(_sink_ACancel_earlyValid_T | _mmios_0_io_mem_access_valid) | _mshrs_0_io_mem_acquire_valid | earlyWinner_1 | earlyWinner_2)) begin	// @[Arbiter.scala:97:79, :107:{14,15,36,41}, mshrs.scala:620:22, :710:22]
        if (`ASSERT_VERBOSE_COND_)	// @[Arbiter.scala:107:14]
          $error("Assertion failed\n    at Arbiter.scala:107 assert (!earlyValids.reduce(_||_) || earlyWinner.reduce(_||_))\n");	// @[Arbiter.scala:107:14]
        if (`STOP_COND_)	// @[Arbiter.scala:107:14]
          $fatal;	// @[Arbiter.scala:107:14]
      end
      if (~reset & ~(~(_T_50 | _mmios_0_io_mem_access_valid) | _T_50 | _mmios_0_io_mem_access_valid)) begin	// @[Arbiter.scala:108:{14,15,36,41}, mshrs.scala:710:22]
        if (`ASSERT_VERBOSE_COND_)	// @[Arbiter.scala:108:14]
          $error("Assertion failed\n    at Arbiter.scala:108 assert (!validQuals .reduce(_||_) || validQuals .reduce(_||_))\n");	// @[Arbiter.scala:108:14]
        if (`STOP_COND_)	// @[Arbiter.scala:108:14]
          $fatal;	// @[Arbiter.scala:108:14]
      end
      if (~reset & ~(~_mshrs_0_io_mem_finish_valid | ~earlyWinner_1_1)) begin	// @[Arbiter.scala:97:79, :105:{13,61,64,67}, mshrs.scala:620:22]
        if (`ASSERT_VERBOSE_COND_)	// @[Arbiter.scala:105:13]
          $error("Assertion failed\n    at Arbiter.scala:105 assert((prefixOR zip earlyWinner) map { case (p,w) => !p || !w } reduce {_ && _})\n");	// @[Arbiter.scala:105:13]
        if (`STOP_COND_)	// @[Arbiter.scala:105:13]
          $fatal;	// @[Arbiter.scala:105:13]
      end
      if (~reset & ~(~_sink_ACancel_earlyValid_T_8 | _mshrs_0_io_mem_finish_valid | earlyWinner_1_1)) begin	// @[Arbiter.scala:97:79, :107:{14,15,36,41}, mshrs.scala:620:22]
        if (`ASSERT_VERBOSE_COND_)	// @[Arbiter.scala:107:14]
          $error("Assertion failed\n    at Arbiter.scala:107 assert (!earlyValids.reduce(_||_) || earlyWinner.reduce(_||_))\n");	// @[Arbiter.scala:107:14]
        if (`STOP_COND_)	// @[Arbiter.scala:107:14]
          $fatal;	// @[Arbiter.scala:107:14]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        beatsLeft = _RANDOM_0[27:19];	// @[Arbiter.scala:87:30, mshrs.scala:555:29]
        state_0 = _RANDOM_0[28];	// @[Arbiter.scala:116:26, mshrs.scala:555:29]
        state_1 = _RANDOM_0[29];	// @[Arbiter.scala:116:26, mshrs.scala:555:29]
        state_2 = _RANDOM_0[30];	// @[Arbiter.scala:116:26, mshrs.scala:555:29]
        beatsLeft_1 = _RANDOM_0[31];	// @[Arbiter.scala:87:30, mshrs.scala:555:29]
        state_1_0 = _RANDOM_1[0];	// @[Arbiter.scala:116:26]
        state_1_1 = _RANDOM_1[1];	// @[Arbiter.scala:116:26]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  BoomIOMSHR mmios_0 (	// @[mshrs.scala:710:22]
    ...
    .io_mem_access_ready              (io_mem_acquire_ready & (idle ? ~_GEN_0 : state_2)),	// @[Arbiter.scala:16:61, :88:28, :116:26, :121:24, :123:31, package.scala:245:43]
  ...
  assign io_mem_acquire_bits_opcode = (muxStateEarly_0 ? 3'h6 : 3'h0) | (muxStateEarly_1 ? 3'h6 : 3'h0) | (muxStateEarly_2 ? _mmios_0_io_mem_access_bits_opcode : 3'h0);	// @[Arbiter.scala:117:30, Mux.scala:27:73, ReadyValidCancel.scala:68:19, mshrs.scala:710:22]
  assign io_mem_acquire_bits_param = (muxStateEarly_0 ? _mshrs_0_io_mem_acquire_bits_param : 3'h0) | (muxStateEarly_1 ? _mshrs_1_io_mem_acquire_bits_param : 3'h0) | (muxStateEarly_2 ? _mmios_0_io_mem_access_bits_param : 3'h0);	// @[Arbiter.scala:117:30, Mux.scala:27:73, mshrs.scala:620:22, :710:22]
  assign io_mem_acquire_bits_size = (muxStateEarly_0 ? 4'h6 : 4'h0) | (muxStateEarly_1 ? 4'h6 : 4'h0) | (muxStateEarly_2 ? _mmios_0_io_mem_access_bits_size : 4'h0);	// @[Arbiter.scala:117:30, Mux.scala:27:73, ReadyValidCancel.scala:68:19, mshrs.scala:710:22]
  assign io_mem_acquire_bits_source = (muxStateEarly_0 ? _mshrs_0_io_mem_acquire_bits_source : 2'h0) | (muxStateEarly_1 ? _mshrs_1_io_mem_acquire_bits_source : 2'h0) | (muxStateEarly_2 ? _mmios_0_io_mem_access_bits_source : 2'h0);	// @[Arbiter.scala:117:30, Mux.scala:27:73, mshrs.scala:620:22, :710:22]
  assign io_mem_acquire_bits_address = (muxStateEarly_0 ? _mshrs_0_io_mem_acquire_bits_address : 32'h0) | (muxStateEarly_1 ? _mshrs_1_io_mem_acquire_bits_address : 32'h0) | (muxStateEarly_2 ? _mmios_0_io_mem_access_bits_address : 32'h0);	// @[Arbiter.scala:117:30, Mux.scala:27:73, mshrs.scala:620:22, :710:22]
  assign io_mem_acquire_bits_mask = {8{muxStateEarly_0}} | {8{muxStateEarly_1}} | (muxStateEarly_2 ? _mmios_0_io_mem_access_bits_mask : 8'h0);	// @[Arbiter.scala:117:30, Mux.scala:27:73, mshrs.scala:710:22]
  assign io_mem_acquire_bits_data = muxStateEarly_2 ? _mmios_0_io_mem_access_bits_data : 64'h0;	// @[Arbiter.scala:117:30, Mux.scala:27:73, mshrs.scala:710:22]
  ...
  assign io_mem_finish_bits_sink = ((beatsLeft_1 ? state_1_0 : _mshrs_0_io_mem_finish_valid) ? _mshrs_0_io_mem_finish_bits_sink : 3'h0) | ((beatsLeft_1 ? state_1_1 : earlyWinner_1_1) ? _mshrs_1_io_mem_finish_bits_sink : 3'h0);	// @[Arbiter.scala:87:30, :97:79, :116:26, :117:30, Mux.scala:27:73, mshrs.scala:620:22]
