...
module TLMonitor_26(
  ...
  wire          _T_905 = _T_1059 & ~(|d_first_counter);	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_24 = _T_929 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    ...
    wire  [64:0]     _T_930 = inflight >> _GEN_23;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire  [64:0]     _T_1016 = 65'h0 >> _GEN_23;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~(io_in_a_bits_source[6:2] == 5'h8 & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 3'h6 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :81:{25,54}, :83:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(io_in_a_bits_source[6:2] == 5'h8 & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 3'h6 & (&(io_in_a_bits_address[27:26])))) begin	// @[Monitor.scala:42:11, :81:25, :92:53, :94:78, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :137:65]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~((_source_ok_WIRE_0 | io_in_a_bits_source[6:2] == 5'h8 & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _source_ok_WIRE_6) & io_in_a_bits_size != 3'h7 & (&(io_in_a_bits_address[27:26])))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :92:25, :114:53, :115:71, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~((_source_ok_WIRE_0 | io_in_a_bits_source[6:2] == 5'h8 & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | io_in_a_bits_source[6:4] == 3'h1 | ~(|(io_in_a_bits_source[6:4])) | _source_ok_WIRE_6) & io_in_a_bits_size != 3'h7 & (&(io_in_a_bits_address[27:26])))) begin	// @[Misc.scala:201:81, Monitor.scala:42:11, :92:25, :122:56, :123:74, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :137:65, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
