...
module TLToAXI4(
  ...
  wire [15:0][3:0] _GEN = '{4'h0, 4'h0, 4'h0, 4'h0, 4'h0, 4'h0, 4'h9, 4'h8, 4'h7, 4'h6, 4'h5, 4'h4, 4'h3, 4'h2, 4'h1, 4'h0};	// @[ToAXI4.scala:168:17]
  ...
  wire [3:0]       out_arw_bits_id = _GEN[auto_in_a_bits_source];	// @[ToAXI4.scala:168:17]
  wire [17:0]      _out_arw_bits_len_T_1 = 18'h7FF << auto_in_a_bits_size;	// @[package.scala:235:71]
  wire [15:0]      _GEN_0 = {{count_1}, {count_1}, {count_1}, {count_1}, {count_1}, {count_1}, {count_10}, {count_9}, {count_8}, {count_7}, {count_6}, {count_5}, {count_4}, {count_3}, {count_2}, {count_1}};	// @[ToAXI4.scala:197:49, :256:28]
  ...
  wire [3:0]       bundleIn_0_d_bits_source = r_wins ? auto_out_r_bits_echo_tl_state_source : auto_out_b_bits_echo_tl_state_source;	// @[ToAXI4.scala:217:53, :239:23]
  ...
  wire [3:0]       d_sel_shiftAmount = r_wins ? auto_out_r_bits_id : auto_out_b_bits_id;	// @[ToAXI4.scala:217:53, :245:31]
  wire             d_last = ~r_wins | auto_out_r_bits_last;	// @[ToAXI4.scala:217:53, :246:23]
  wire             _inc_T_9 = _queue_arw_deq_io_enq_ready & out_arw_valid;	// @[Decoupled.scala:51:35, :375:21, ToAXI4.scala:199:45]
  wire             inc = out_arw_bits_id == 4'h0 & _inc_T_9;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             _dec_T_19 = auto_in_d_ready & bundleIn_0_d_valid;	// @[Decoupled.scala:51:35, ToAXI4.scala:221:24]
  wire             dec = d_sel_shiftAmount == 4'h0 & d_last & _dec_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_1 = out_arw_bits_id == 4'h1 & _inc_T_9;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_1 = d_sel_shiftAmount == 4'h1 & d_last & _dec_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_2 = out_arw_bits_id == 4'h2 & _inc_T_9;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_2 = d_sel_shiftAmount == 4'h2 & d_last & _dec_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_3 = out_arw_bits_id == 4'h3 & _inc_T_9;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_3 = d_sel_shiftAmount == 4'h3 & d_last & _dec_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_4 = out_arw_bits_id == 4'h4 & _inc_T_9;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_4 = d_sel_shiftAmount == 4'h4 & d_last & _dec_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_5 = out_arw_bits_id == 4'h5 & _inc_T_9;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_5 = d_sel_shiftAmount == 4'h5 & d_last & _dec_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_6 = out_arw_bits_id == 4'h6 & _inc_T_9;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_6 = d_sel_shiftAmount == 4'h6 & d_last & _dec_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_7 = out_arw_bits_id == 4'h7 & _inc_T_9;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_7 = d_sel_shiftAmount == 4'h7 & d_last & _dec_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_8 = out_arw_bits_id == 4'h8 & _inc_T_9;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_8 = d_sel_shiftAmount == 4'h8 & d_last & _dec_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
  wire             inc_9 = out_arw_bits_id == 4'h9 & _inc_T_9;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:168:17, :244:58, :260:22]
  wire             dec_9 = d_sel_shiftAmount == 4'h9 & d_last & _dec_T_19;	// @[Decoupled.scala:51:35, OneHot.scala:64:{12,27}, ToAXI4.scala:245:{31,93}, :246:23, :261:32]
