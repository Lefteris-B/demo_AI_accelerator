...
module MulAddRecFN(
  ...
  MulAddRecFNToRaw_postMul mulAddRecFNToRaw_postMul (	// @[MulAddRecFN.scala:317:15]
    ...
    .io_mulAddResult               ({1'h0, {24'h0, _mulAddRecFNToRaw_preMul_io_mulAddA} * {24'h0, _mulAddRecFNToRaw_preMul_io_mulAddB}} + {1'h0, _mulAddRecFNToRaw_preMul_io_mulAddC}),	// @[MulAddRecFN.scala:315:15, :325:45, :326:50]
