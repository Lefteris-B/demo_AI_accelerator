...
module TLXbar_8(
  ...
  wire        out_8_valid = auto_out_b_valid & ~(auto_out_b_bits_source[2]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:181:40]
  wire        out_10_valid = auto_out_d_valid & ~(auto_out_d_bits_source[2]);	// @[Parameters.scala:54:{10,32}, Xbar.scala:181:40]
  ...
  TLMonitor_44 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_b_bits_source  (auto_out_b_bits_source[1:0]),	// @[Xbar.scala:230:69]
    ...
    .io_in_d_bits_source  (auto_out_d_bits_source[1:0]),	// @[Xbar.scala:230:69]
  ...
  TLMonitor_45 monitor_1 (	// @[Nodes.scala:24:25]
    .clock                (clock),
    .reset                (reset),
  ...
  assign auto_in_0_b_bits_source = auto_out_b_bits_source[1:0];	// @[Xbar.scala:230:69]
  ...
  assign auto_in_0_d_bits_source = auto_out_d_bits_source[1:0];	// @[Xbar.scala:230:69]
  ...
  assign auto_out_a_bits_source = (muxStateEarly_0 ? {1'h0, auto_in_0_a_bits_source} : 3'h0) | {muxStateEarly_1, 2'h0};	// @[Arbiter.scala:25:66, :117:30, Mux.scala:27:73, Xbar.scala:239:29]
  ...
  assign auto_out_a_bits_mask = (muxStateEarly_0 ? auto_in_0_a_bits_mask : 8'h0) | {8{muxStateEarly_1}};	// @[Arbiter.scala:117:30, Bundles.scala:259:74, Mux.scala:27:73]
  assign auto_out_a_bits_data = muxStateEarly_0 ? auto_in_0_a_bits_data : 64'h0;	// @[Arbiter.scala:117:30, Mux.scala:27:73]
