...
module PTW(
  ...
  wire            _r_pte_T_21 = _arb_io_out_ready_T_2 & _arb_io_out_valid;	// @[Decoupled.scala:51:35, PTW.scala:236:19, :240:43]
  assign readEnable = ~l2_refill & _r_pte_T_21;	// @[Decoupled.scala:51:35, PTW.scala:410:26, :479:{20,31}]
  ...
  wire            _GEN_8 = _T_203 & _r_pte_T_21;	// @[Decoupled.scala:51:35, PTW.scala:240:30, :587:32]
  ...
  wire [7:0][2:0] _GEN_11 = {{3'h0}, {state}, {state}, {io_mem_s2_xcpt_ae_ld ? 3'h0 : 3'h5}, {state}, {l2_hit ? 3'h1 : 3'h4}, {pte_cache_hit ? state : io_mem_req_ready ? 3'h2 : 3'h1}, {_r_pte_T_21 ? {2'h0, _arb_io_out_bits_valid} : state}};	// @[Decoupled.scala:51:35, Mux.scala:47:70, PTW.scala:233:22, :236:19, :240:30, :379:24, :384:15, :389:24, :493:27, :581:31, :585:18, :587:32, :595:{20,26}, :621:35, :627:34, :631:{20,26}, :636:{18,24}, :639:18, :641:35, :643:20, :648:18]
  ...
  always @(posedge clock) begin
      ...
      if (mem_resp_valid) begin	// @[PTW.scala:293:31]
        if (traverse)	// @[PTW.scala:316:48]
          ...
          if (stage2)	// @[PTW.scala:283:19]
            ...
            if (_r_pte_T_21)	// @[Decoupled.scala:51:35]
              count <= 2'h0;	// @[PTW.scala:259:18]
          end
        ...
        count <= 2'h2;	// @[PTW.scala:259:18]
      if (_T_203 & _r_pte_T_21) begin	// @[Decoupled.scala:51:35, PTW.scala:240:30, :585:18, :587:32]
    ...
    if (_T_203)	// @[PTW.scala:240:30]
      resp_ae_ptw <= ~_r_pte_T_21 & resp_ae_ptw;	// @[Decoupled.scala:51:35, PTW.scala:260:24, :587:32, :603:21]
    ...
    stage2 <= do_switch | (~mem_resp_valid | traverse | ~(_T_239 & stage2)) & (_GEN_8 ? _arb_io_out_bits_bits_stage2 : stage2);	// @[PTW.scala:236:19, :283:19, :293:31, :316:48, :583:30, :585:18, :587:32, :596:22, :674:8, :689:25, :692:21, :701:{45,57}, :702:23, :703:18, :737:20, :745:12]
    stage2_final <= mem_resp_valid & ~traverse & _T_239 & ~stage2 | (_GEN_8 ? _arb_io_out_bits_bits_stage2 & ~_arb_io_out_bits_bits_vstage1 : stage2_final);	// @[PTW.scala:236:19, :283:19, :284:25, :293:31, :316:48, :585:18, :587:32, :597:{22,53,56}, :689:25, :692:21, :701:{45,57}, :702:23, :706:24]
  ...
  `ifndef SYNTHESIS
    always @(posedge clock) begin	// @[PTW.scala:407:9]
      ...
      if (_GEN_8 & ~reset & ~(~_arb_io_out_bits_bits_need_gpa | _arb_io_out_bits_bits_stage2)) begin	// @[PTW.scala:236:19, :480:87, :587:32, :613:{15,47}]
  ...
  Arbiter_29 arb (	// @[PTW.scala:236:19]
  ...
  OptimizationBarrier_42 state_barrier (	// @[package.scala:259:25]
    .io_x (io_mem_s2_nack ? 3'h1 : mem_resp_valid ? {2'h0, _GEN_14} : _T_222 ? 3'h0 : _GEN_11[state]),	// @[PTW.scala:233:22, :240:30, :293:31, :384:15, :389:24, :410:26, :581:31, :585:18, :587:32, :621:35, :636:18, :641:35, :648:18, :683:{16,30}, :685:16, :689:25, :691:16, :692:21, :701:57, :711:19, :716:122, :732:25, :734:16]
    .io_y (_state_barrier_io_y)
  );
  OptimizationBarrier_43 r_pte_barrier (	// @[package.scala:259:25]
    .io_x_ppn (_r_pte_T_1 ? {24'h0, r_2[25:6]} : _r_pte_T_5 ? {24'h0, (hits[0] ? data_0 : 20'h0) | (hits[1] ? data_1 : 20'h0) | (hits[2] ? data_2 : 20'h0) | (hits[3] ? data_3 : 20'h0) | (hits[4] ? data_4 : 20'h0) | (hits[5] ? data_5 : 20'h0) | (hits[6] ? data_6 : 20'h0) | (hits[7] ? data_7 : 20'h0)} : do_switch ? {r_hgatp_ppn[43:2], 2'h0} : mem_resp_valid ? (_r_pte_T_8 ? {17'h0, _GEN_0 ? _T_15 : _leaf_T_5 ? {_T_15[26:9], aux_pte_ppn[8:0]} : {_T_15[26:18], aux_pte_ppn[17:0]}} & ((&_merged_pte_superpage_mask_T) | _merged_pte_superpage_mask_T == 2'h2 ? 44'hFFFFFFFFFFF : _merged_pte_superpage_mask_T == 2'h1 ? 44'hFFFFFFFFE00 : 44'hFFFFFFC0000) : {17'h0, _T_15}) : (&state) & ~homogeneous ? (count[0] ? {r_pte_ppn[43:9], r_req_addr[8:0]} : {r_pte_ppn[43:18], r_req_addr[17:0]}) : _r_pte_T_21 ? (_arb_io_out_bits_bits_stage2 | _arb_io_out_bits_bits_vstage1 ? 44'h0 : io_dpath_ptbr_ppn) : r_pte_ppn),	// @[Cat.scala:33:92, Decoupled.scala:51:35, Mux.scala:27:73, :29:36, PTW.scala:233:22, :236:19, :259:18, :270:18, :275:18, :276:20, :280:20, :291:16, :293:31, :307:{13,19}, :313:93, :355:{49,79}, :367:19, :378:43, :491:59, :503:16, :551:36, :583:30, :644:32, :662:45, :663:{64,125}, :665:24, :670:{8,16}, :672:{8,50}, :674:8, :676:{8,28,56}, :678:{8,15,40,43}, :680:{8,31}, :689:25, :692:21, :769:13, :778:30, Reg.scala:19:16, package.scala:32:47, :33:{76,86}]
