...
module TLMonitor_53(
  ...
  wire [259:0] _a_sizes_set_T_1 = {255'h0, _T_1313 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {252'h0, io_in_a_bits_source, 3'h0};	// @[Bundles.scala:259:74, Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _T_398 = io_in_a_bits_size > 4'h2;	// @[Misc.scala:205:21]
    wire             mask_size = io_in_a_bits_size[1:0] == 2'h2;	// @[Bundles.scala:111:27, Misc.scala:208:26, OneHot.scala:63:49]
    wire             mask_acc = _T_398 | mask_size & ~(io_in_a_bits_address[2]);	// @[Misc.scala:205:21, :208:26, :209:26, :210:20, :214:{29,38}]
    wire             mask_acc_1 = _T_398 | mask_size & io_in_a_bits_address[2];	// @[Misc.scala:205:21, :208:26, :209:26, :214:{29,38}]
    ...
    wire  [255:0]    _GEN_26 = {248'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:638:40]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~_T_398) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :81:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_8 & ~reset & ~_T_398) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~(io_in_a_bits_size < 4'hD & io_in_a_bits_size < 4'h4 & (_GEN_10 == 19'h0 | io_in_a_bits_address[31:12] == 20'h3 | _GEN_11 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:12] == 20'h2010 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h10000 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:28] == 4'h8))) begin	// @[Monitor.scala:42:11, :130:56, :131:74, Parameters.scala:92:42, :137:{31,45,65}, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_16 & ~reset & ~(io_in_a_bits_size < 4'hD & io_in_a_bits_size < 4'h4 & (_GEN_10 == 19'h0 | io_in_a_bits_address[31:12] == 20'h3 | _GEN_11 == 19'h0 | io_in_a_bits_address[31:16] == 16'h200 | io_in_a_bits_address[31:12] == 20'h2010 | io_in_a_bits_address[31:26] == 6'h3 | io_in_a_bits_address[31:12] == 20'h10000 | io_in_a_bits_address[31:12] == 20'h54000 | io_in_a_bits_address[31:28] == 4'h8))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, Parameters.scala:92:42, :137:{31,45,65}, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        address = {_RANDOM_0[31:24], _RANDOM_1[23:0]};	// @[Edges.scala:228:27, Monitor.scala:388:22]
        ...
        source_1 = _RANDOM_2[14:10];	// @[Edges.scala:228:27, Monitor.scala:538:22]
        sink = _RANDOM_2[17:15];	// @[Edges.scala:228:27, Monitor.scala:539:22]
        denied = _RANDOM_2[18];	// @[Edges.scala:228:27, Monitor.scala:540:22]
        inflight = {_RANDOM_2[31:19], _RANDOM_3[18:0]};	// @[Edges.scala:228:27, Monitor.scala:611:27]
        inflight_opcodes = {_RANDOM_3[31:19], _RANDOM_4, _RANDOM_5, _RANDOM_6, _RANDOM_7[18:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_7[31:19], _RANDOM_8, _RANDOM_9, _RANDOM_10, _RANDOM_11, _RANDOM_12, _RANDOM_13, _RANDOM_14, _RANDOM_15[18:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_15[27:19];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        d_first_counter_1 = {_RANDOM_15[31:28], _RANDOM_16[4:0]};	// @[Edges.scala:228:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_16[31:5], _RANDOM_17[4:0]};	// @[Edges.scala:228:27, Monitor.scala:706:27]
        d_first_counter_2 = _RANDOM_30[22:14];	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
