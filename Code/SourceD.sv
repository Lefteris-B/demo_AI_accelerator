...
module SourceD(
  ...
  wire            s1_bypass = s1_latch_bypass ? s1_x_bypass : s1_bypass_r;	// @[Reg.scala:19:16, SourceD.scala:89:32, :90:22, :358:44]
  ...
  wire            s1_need_r = ~s1_bypass & s1_req_prio_0 & s1_req_opcode != 3'h5 & ~s1_grant & ((|s1_req_opcode) | s1_req_size < 3'h3);	// @[SourceD.scala:87:19, :90:22, :91:78, :92:76, :93:{66,78,88}, :94:{34,50,65}]
  wire            _io_bs_radr_valid_output = _s1_valid_T & s1_need_r & ~s1_block_r;	// @[SourceD.scala:84:27, :89:40, :93:88, :95:{56,59}]
  wire [2:0]      s1_beat = (busy ? s1_req_reg_offset[5:3] : io_req_bits_offset[5:3]) | s1_counter;	// @[Reg.scala:19:16, SourceD.scala:83:21, :85:27, :87:19, :101:56]
  ...
  wire [7:0][2:0] _GEN = {{3'h4}, {{2'h2, s3_req_param != 3'h2}}, {3'h2}, {3'h1}, {3'h1}, {3'h1}, {3'h0}, {3'h0}};	// @[Reg.scala:19:16, SourceD.scala:85:27, :194:31, :213:{18,32}, :221:24, :279:84, :280:84]
  wire [2:0]      d_bits_opcode = s3_req_prio_0 ? _GEN[s3_req_opcode] : 3'h6;	// @[Reg.scala:19:16, SourceD.scala:92:33, :221:24]
  ...
  assign s3_bypass_data = s3_bypass_data_REG ? _atomics_io_data_out : s3_bypass_data_REG_1;	// @[SourceD.scala:209:75, :257:23, :335:{19,66}]
  assign s1_x_bypass = s2_req_set == s1_req_set & s2_req_way == s1_req_way & s2_beat == s1_beat & s2_full & s2_retires | s3_req_set == s1_req_set & s3_req_way == s1_req_way & s3_beat == s1_beat & s3_full & s3_retires | s4_req_set == s1_req_set & s4_req_way == s1_req_way & s4_beat == s1_beat & s4_full;	// @[Reg.scala:19:16, SourceD.scala:87:19, :101:56, :146:24, :189:24, :247:24, :342:{32,61,87,110}, :343:{32,61,87,110}, :344:{32,61,87,99}, :358:44]
  ...
  wire            s1_last = s1_counter == (s1_single ? 3'h0 : ~(_s1_beats1_T_1[5:3]));	// @[SourceD.scala:85:27, :97:22, :100:22, :102:28, package.scala:235:{46,71,76}]
  ...
  wire [2:0]      pre_s3_beat = s3_latch ? s2_beat : s3_beat;	// @[Reg.scala:19:16, SourceD.scala:176:18, :317:24]
  always @(posedge clock) begin
    ...
    if (s2_latch) begin	// @[SourceD.scala:128:18]
      ...
      s2_need_d <= ~(s1_req_prio_0 ? ~(s1_req_opcode[2]) : s1_req_opcode[0]) | s1_counter == 3'h0;	// @[Reg.scala:19:16, SourceD.scala:85:27, :87:19, :96:{23,40,54,72}, :103:29, :155:{29,41}]
    end
    if (s2_valid_pb) begin	// @[SourceD.scala:147:28]
      if (s2_req_prio_0) begin	// @[Reg.scala:19:16]
        ...
        s2_pdata_r_mask <= 8'hFF;	// @[Reg.scala:19:16, SourceD.scala:160:64]
    ...
    if (s3_latch) begin	// @[SourceD.scala:176:18]
      ...
      if (s2_valid_pb) begin	// @[SourceD.scala:147:28]
        if (s2_req_prio_0) begin	// @[Reg.scala:19:16]
          ...
          s3_pdata_mask <= 8'hFF;	// @[Reg.scala:19:16, SourceD.scala:160:64]
    ...
    if (s4_latch) begin	// @[SourceD.scala:246:41]
      ...
      if (s3_req_bad)	// @[Reg.scala:19:16]
        s4_adjusted_opcode <= 3'h4;	// @[Reg.scala:19:16, SourceD.scala:194:31]
      ...
      if (s3_bypass) begin	// @[Reg.scala:19:16]
        if (s3_bypass_data_REG)	// @[SourceD.scala:335:19]
          s4_rdata <= _atomics_io_data_out;	// @[Reg.scala:19:16, SourceD.scala:257:23]
        else	// @[SourceD.scala:335:19]
          s4_rdata <= s3_bypass_data_REG_1;	// @[Reg.scala:19:16, SourceD.scala:335:66]
      end
      else	// @[Reg.scala:19:16]
        s4_rdata <= _queue_io_deq_bits_data;	// @[Reg.scala:19:16, SourceD.scala:119:21]
    end
    ...
    s3_bypass_data_REG <= (s4_latch ? s3_req_set : s4_req_set) == pre_s3_req_set & (s4_latch ? s3_req_way : s4_req_way) == pre_s3_req_way & (s4_latch ? s3_beat : s4_beat) == pre_s3_beat & (s4_latch | ~(io_bs_wadr_ready | ~s4_need_bs) & s4_full);	// @[Reg.scala:19:16, SourceD.scala:246:41, :247:24, :288:29, :313:24, :314:24, :317:24, :318:24, :324:{30,34,53,69}, :326:{40,77,111,127}, :335:19]
    if ((retire ? s4_req_set : s5_req_set) == pre_s3_req_set & (retire ? s4_req_way : s5_req_way) == pre_s3_req_way & (retire ? s4_beat : s5_beat) == pre_s3_beat) begin	// @[Reg.scala:19:16, SourceD.scala:298:24, :313:24, :315:24, :317:24, :319:24, :327:{40,77,96,111}]
      if (retire)	// @[SourceD.scala:298:24]
        ...
        s3_bypass_data_REG_1 <= s5_dat;	// @[Reg.scala:19:16, SourceD.scala:335:66]
    end
    else if ((retire ? s5_req_set : s6_req_set) == pre_s3_req_set & (retire ? s5_req_way : s6_req_way) == pre_s3_req_way & (retire ? s5_beat : s6_beat) == pre_s3_beat) begin	// @[Reg.scala:19:16, SourceD.scala:298:24, :313:24, :316:24, :317:24, :320:24, :328:{40,77,96,111}]
      if (retire)	// @[SourceD.scala:298:24]
        s3_bypass_data_REG_1 <= s5_dat;	// @[Reg.scala:19:16, SourceD.scala:335:66]
      else	// @[SourceD.scala:298:24]
        s3_bypass_data_REG_1 <= s6_dat;	// @[Reg.scala:19:16, SourceD.scala:335:66]
    end
    else if (retire)	// @[SourceD.scala:298:24]
      s3_bypass_data_REG_1 <= s6_dat;	// @[Reg.scala:19:16, SourceD.scala:335:66]
    else	// @[SourceD.scala:298:24]
      s3_bypass_data_REG_1 <= s7_dat;	// @[Reg.scala:19:16, SourceD.scala:335:66]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        s1_counter = _RANDOM_0[4:2];	// @[SourceD.scala:83:21, :85:27]
        s1_req_reg_prio_0 = _RANDOM_0[5];	// @[Reg.scala:19:16, SourceD.scala:83:21]
        s1_req_reg_prio_2 = _RANDOM_0[7];	// @[Reg.scala:19:16, SourceD.scala:83:21]
        s1_req_reg_opcode = _RANDOM_0[11:9];	// @[Reg.scala:19:16, SourceD.scala:83:21]
        s1_req_reg_param = _RANDOM_0[14:12];	// @[Reg.scala:19:16, SourceD.scala:83:21]
        s1_req_reg_size = _RANDOM_0[17:15];	// @[Reg.scala:19:16, SourceD.scala:83:21]
        s1_req_reg_source = _RANDOM_0[23:18];	// @[Reg.scala:19:16, SourceD.scala:83:21]
        s1_req_reg_offset = _RANDOM_1[10:5];	// @[Reg.scala:19:16]
        s1_req_reg_put = _RANDOM_1[16:11];	// @[Reg.scala:19:16]
        s1_req_reg_set = _RANDOM_1[26:17];	// @[Reg.scala:19:16]
        s1_req_reg_sink = _RANDOM_1[29:27];	// @[Reg.scala:19:16]
        ...
        s1_bypass_r = _RANDOM_2[3];	// @[Reg.scala:19:16]
        queue_io_enq_valid_REG = _RANDOM_2[4];	// @[Reg.scala:19:16, SourceD.scala:120:40]
        queue_io_enq_valid_REG_1 = _RANDOM_2[5];	// @[Reg.scala:19:16, SourceD.scala:120:32]
        s2_full = _RANDOM_2[6];	// @[Reg.scala:19:16, SourceD.scala:146:24]
        s2_valid_pb = _RANDOM_2[7];	// @[Reg.scala:19:16, SourceD.scala:147:28]
        s2_beat = _RANDOM_2[10:8];	// @[Reg.scala:19:16]
        ...
        s2_req_source = _RANDOM_2[30:25];	// @[Reg.scala:19:16]
        s2_req_put = _RANDOM_3[23:18];	// @[Reg.scala:19:16]
        s2_req_set = {_RANDOM_3[31:24], _RANDOM_4[1:0]};	// @[Reg.scala:19:16]
        s2_req_sink = _RANDOM_4[4:2];	// @[Reg.scala:19:16]
        s2_req_way = _RANDOM_4[7:5];	// @[Reg.scala:19:16]
        s2_req_bad = _RANDOM_4[8];	// @[Reg.scala:19:16]
        s2_last = _RANDOM_4[9];	// @[Reg.scala:19:16]
        s2_need_r = _RANDOM_4[10];	// @[Reg.scala:19:16]
        s2_need_pb = _RANDOM_4[11];	// @[Reg.scala:19:16]
        s2_retires = _RANDOM_4[12];	// @[Reg.scala:19:16]
        s2_need_d = _RANDOM_4[13];	// @[Reg.scala:19:16]
        s2_pdata_r_data = {_RANDOM_4[31:14], _RANDOM_5, _RANDOM_6[13:0]};	// @[Reg.scala:19:16]
        s2_pdata_r_mask = _RANDOM_6[21:14];	// @[Reg.scala:19:16]
        s2_pdata_r_corrupt = _RANDOM_6[22];	// @[Reg.scala:19:16]
        s3_full = _RANDOM_6[23];	// @[Reg.scala:19:16, SourceD.scala:189:24]
        s3_valid_d = _RANDOM_6[24];	// @[Reg.scala:19:16, SourceD.scala:190:27]
        s3_beat = _RANDOM_6[27:25];	// @[Reg.scala:19:16]
        s3_bypass = _RANDOM_6[28];	// @[Reg.scala:19:16]
        s3_req_prio_0 = _RANDOM_6[29];	// @[Reg.scala:19:16]
        s3_req_prio_2 = _RANDOM_6[31];	// @[Reg.scala:19:16]
        s3_req_opcode = _RANDOM_7[3:1];	// @[Reg.scala:19:16]
        s3_req_param = _RANDOM_7[6:4];	// @[Reg.scala:19:16]
        s3_req_size = _RANDOM_7[9:7];	// @[Reg.scala:19:16]
        s3_req_source = _RANDOM_7[15:10];	// @[Reg.scala:19:16]
        s3_req_set = _RANDOM_8[18:9];	// @[Reg.scala:19:16]
        s3_req_sink = _RANDOM_8[21:19];	// @[Reg.scala:19:16]
        s3_req_way = _RANDOM_8[24:22];	// @[Reg.scala:19:16]
        s3_req_bad = _RANDOM_8[25];	// @[Reg.scala:19:16]
        s3_pdata_data = {_RANDOM_8[31:27], _RANDOM_9, _RANDOM_10[26:0]};	// @[Reg.scala:19:16]
        s3_pdata_mask = {_RANDOM_10[31:27], _RANDOM_11[2:0]};	// @[Reg.scala:19:16]
        s3_pdata_corrupt = _RANDOM_11[3];	// @[Reg.scala:19:16]
        s3_need_bs = _RANDOM_11[4];	// @[Reg.scala:19:16]
        s3_retires = _RANDOM_11[5];	// @[Reg.scala:19:16]
        s3_need_r = _RANDOM_11[6];	// @[Reg.scala:19:16]
        s4_full = _RANDOM_11[7];	// @[Reg.scala:19:16, SourceD.scala:247:24]
        s4_beat = _RANDOM_11[10:8];	// @[Reg.scala:19:16]
        s4_need_bs = _RANDOM_11[12];	// @[Reg.scala:19:16]
        s4_need_pb = _RANDOM_11[13];	// @[Reg.scala:19:16]
        s4_req_prio_2 = _RANDOM_11[16];	// @[Reg.scala:19:16]
        s4_req_param = _RANDOM_11[23:21];	// @[Reg.scala:19:16]
        s4_req_set = {_RANDOM_12[31:26], _RANDOM_13[3:0]};	// @[Reg.scala:19:16]
        s4_req_way = _RANDOM_13[9:7];	// @[Reg.scala:19:16]
        s4_adjusted_opcode = _RANDOM_13[13:11];	// @[Reg.scala:19:16]
        s4_pdata_data = {_RANDOM_13[31:14], _RANDOM_14, _RANDOM_15[13:0]};	// @[Reg.scala:19:16]
        s4_pdata_mask = _RANDOM_15[21:14];	// @[Reg.scala:19:16]
        s4_pdata_corrupt = _RANDOM_15[22];	// @[Reg.scala:19:16]
        s4_rdata = {_RANDOM_15[31:23], _RANDOM_16, _RANDOM_17[22:0]};	// @[Reg.scala:19:16]
        s5_req_set = _RANDOM_19[12:3];	// @[Reg.scala:19:16]
        s5_req_way = _RANDOM_19[18:16];	// @[Reg.scala:19:16]
        s5_beat = _RANDOM_19[22:20];	// @[Reg.scala:19:16]
        s5_dat = {_RANDOM_19[31:23], _RANDOM_20, _RANDOM_21[22:0]};	// @[Reg.scala:19:16]
        s6_req_set = _RANDOM_23[12:3];	// @[Reg.scala:19:16]
        s6_req_way = _RANDOM_23[18:16];	// @[Reg.scala:19:16]
        s6_beat = _RANDOM_23[22:20];	// @[Reg.scala:19:16]
        s6_dat = {_RANDOM_23[31:23], _RANDOM_24, _RANDOM_25[22:0]};	// @[Reg.scala:19:16]
        s7_dat = {_RANDOM_25[31:23], _RANDOM_26, _RANDOM_27[22:0]};	// @[Reg.scala:19:16]
        s3_bypass_data_REG = _RANDOM_27[23];	// @[Reg.scala:19:16, SourceD.scala:335:19]
        s3_bypass_data_REG_1 = {_RANDOM_27[31:24], _RANDOM_28, _RANDOM_29[23:0]};	// @[Reg.scala:19:16, SourceD.scala:335:66]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  assign io_d_bits_param = s3_req_prio_0 & (s3_req_opcode == 3'h6 | (&s3_req_opcode)) ? {1'h0, s3_req_param == 3'h0} : 2'h0;	// @[Reg.scala:19:16, SourceD.scala:83:21, :85:27, :92:33, :201:{30,47,64}, :222:{24,40,54,68}]
  ...
  assign io_d_bits_data = s3_bypass ? s3_bypass_data : _queue_io_deq_bits_data;	// @[Reg.scala:19:16, SourceD.scala:119:21, :209:75]
  ...
  assign io_bs_wadr_bits_mask = |s4_pdata_mask;	// @[Reg.scala:19:16, SourceD.scala:273:87]
