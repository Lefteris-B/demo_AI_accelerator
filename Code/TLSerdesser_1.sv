...
module TLSerdesser_1(
  ...
  wire        _inDes_io_out_ready_T = _inDes_io_out_bits_chanId == 3'h0;	// @[Bundles.scala:262:74, Serdes.scala:234:37, :629:23]
  ...
  TLMonitor_69 monitor (	// @[Nodes.scala:24:25]
    ...
    .io_in_d_bits_sink    (_inDes_io_out_bits_union[3:1]),	// @[Serdes.scala:465:17, :629:23]
  ...
  HellaPeekingArbiter outArb (	// @[Serdes.scala:622:24]
    ...
    .io_in_4_bits_source  ({3'h0, auto_manager_in_a_bits_source}),	// @[Bundles.scala:262:74, Serdes.scala:257:20]
  ...
  assign auto_manager_in_d_bits_sink = _inDes_io_out_bits_union[3:1];	// @[Serdes.scala:465:17, :629:23]
