...
module FrontendTLB(
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      last_translated_valid <= ~_T_5 & (tlbReqFire | last_translated_valid);	// @[Decoupled.scala:51:35, FrontendTLB.scala:25:49, :118:40, :133:44, :134:29, :139:31, :140:29]
      if (tlbReqFire) begin	// @[Decoupled.scala:51:35]
      ...
      last_translated_valid_1 <= ~_T_5 & (tlbReqFire_1 | last_translated_valid_1);	// @[Decoupled.scala:51:35, FrontendTLB.scala:25:49, :118:40, :133:44, :134:29, :139:31, :140:29]
      if (tlbReqFire_1) begin	// @[Decoupled.scala:51:35]
  ...
  assign io_clients_0_resp_miss = ~tlbReqFire & ~io_clients_0_resp_miss_REG;	// @[Decoupled.scala:51:35, FrontendTLB.scala:143:23, :144:19, :148:{24,27,35}]
  ...
  assign io_clients_1_resp_miss = ~tlbReqFire_1 & ~io_clients_1_resp_miss_REG;	// @[Decoupled.scala:51:35, FrontendTLB.scala:143:23, :144:19, :148:{24,27,35}]
