  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        req_r_source = _RANDOM_0[17:15];	// @[Reg.scala:19:16, SourceC.scala:57:21]
        req_r_tag = _RANDOM_0[30:18];	// @[Reg.scala:19:16, SourceC.scala:57:21]
        req_r_set = {_RANDOM_0[31], _RANDOM_1[8:0]};	// @[Reg.scala:19:16, SourceC.scala:57:21]
        req_r_way = _RANDOM_1[11:9];	// @[Reg.scala:19:16]
        s2_valid = _RANDOM_1[13];	// @[Reg.scala:19:16, SourceC.scala:93:25]
        ...
        s3_valid = _RANDOM_2[22];	// @[Reg.scala:19:16, SourceC.scala:99:25]
