...
module CoherenceManagerWrapper(
  ...
  wire [2:0]  _cork_auto_in_d_bits_source;	// @[Configs.scala:106:26]
  ...
  wire [3:0]  _cork_auto_out_a_bits_source;	// @[Configs.scala:106:26]
  ...
  wire [7:0]  _InclusiveCache_inner_TLBuffer_auto_out_a_bits_mask;	// @[Parameters.scala:55:69]
  wire [63:0] _InclusiveCache_inner_TLBuffer_auto_out_a_bits_data;	// @[Parameters.scala:55:69]
  ...
  wire [63:0] _InclusiveCache_inner_TLBuffer_auto_out_c_bits_data;	// @[Parameters.scala:55:69]
  ...
  wire [2:0]  _InclusiveCache_inner_TLBuffer_auto_out_e_bits_sink;	// @[Parameters.scala:55:69]
  ...
  wire [2:0]  _l2_auto_in_d_bits_sink;	// @[Configs.scala:77:24]
  wire        _l2_auto_in_d_bits_denied;	// @[Configs.scala:77:24]
  wire [63:0] _l2_auto_in_d_bits_data;	// @[Configs.scala:77:24]
  ...
  wire [2:0]  _l2_auto_out_a_bits_source;	// @[Configs.scala:77:24]
  ...
  wire [2:0]  _l2_auto_out_c_bits_source;	// @[Configs.scala:77:24]
