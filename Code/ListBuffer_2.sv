...
module ListBuffer_2(
  ...
  wire [32:0] _freeOH_T_3 = _freeOH_T_22 | {_freeOH_T_22[31:0], 1'h0};	// @[ListBuffer.scala:52:25, package.scala:245:{43,53}]
  ...
  wire [33:0] freeOH = {~(_freeOH_T_15 | {_freeOH_T_15[0], 32'h0}), 1'h1} & {1'h0, _freeOH_T_22};	// @[ListBuffer.scala:52:{16,25,32,38}, package.scala:245:{43,48,53}]
  wire [14:0] _GEN = freeOH[31:17] | freeOH[15:1];	// @[ListBuffer.scala:52:38, OneHot.scala:30:18, :31:18, :32:28]
  ...
  wire [5:0]  data_MPORT_addr = {|(freeOH[33:32]), |(freeOH[31:16]), |(_GEN[14:7]), |(_GEN_0[6:3]), |(_GEN_1[2:1]), _GEN_1[2] | _GEN_1[0]};	// @[Cat.scala:33:92, ListBuffer.scala:52:38, OneHot.scala:30:18, :31:18, :32:{14,28}]
  wire [20:0] _push_valid_T = valid >> io_push_bits_index;	// @[ListBuffer.scala:45:22, :61:25]
  wire        _io_push_ready_output = used != 33'h1FFFFFFFF;	// @[ListBuffer.scala:48:22, :52:25, :63:26]
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      valid <= valid & ~(io_pop_valid & _head_ext_R0_data == _tail_ext_R0_data ? _valid_clr_T[20:0] : 21'h0) | (data_MPORT_en ? _valid_set_T[20:0] : 21'h0);	// @[Decoupled.scala:51:35, ListBuffer.scala:45:22, :46:18, :47:18, :64:25, :65:15, :86:24, :88:{20,48}, :89:17, :97:{21,23,35}, OneHot.scala:64:{12,27}, compatibility.scala:76:26]
      used <= used & ~(io_pop_valid ? _used_clr_T[32:0] : 33'h0) | (data_MPORT_en ? freeOH[32:0] : 33'h0);	// @[Decoupled.scala:51:35, ListBuffer.scala:48:22, :52:38, :64:25, :66:14, :86:24, :87:14, :96:{21,23,35}, OneHot.scala:64:{12,27}, compatibility.scala:76:26]
    end
  end // always @(posedge)
  `ifndef SYNTHESIS
    wire  [20:0] _T_2 = valid >> io_pop_bits;	// @[ListBuffer.scala:45:22, :84:39]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        _RANDOM_0 = `RANDOM;
        _RANDOM_1 = `RANDOM;
        valid = _RANDOM_0[20:0];	// @[ListBuffer.scala:45:22]
        used = {_RANDOM_0[31:21], _RANDOM_1[21:0]};	// @[ListBuffer.scala:45:22, :48:22]
      `endif // RANDOMIZE_REG_INIT
    end // initial
