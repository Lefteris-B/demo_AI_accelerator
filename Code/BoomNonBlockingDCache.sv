...
module BoomNonBlockingDCache(
  ...
  wire [3:0]       out_2_bits_size = (muxStateEarly_0 ? 4'h6 : 4'h0) | (muxStateEarly_1 ? _prober_io_rep_bits_size : 4'h0);	// @[Arbiter.scala:117:30, Mux.scala:27:73, ReadyValidCancel.scala:68:19, dcache.scala:433:22, :569:27]
  wire [2:0]       out_2_bits_opcode = (muxStateEarly_0 ? _wb_io_release_bits_opcode : 3'h0) | {muxStateEarly_1, 2'h0};	// @[Arbiter.scala:117:30, Mux.scala:27:73, dcache.scala:432:18, :569:27]
  wire             _io_lsu_perf_release_T = auto_out_c_ready & out_2_valid;	// @[Arbiter.scala:125:29, Decoupled.scala:51:35]
  ...
  wire [11:0]      s0_req_0_uop_br_mask = _T_7 ? io_lsu_req_bits_0_bits_uop_br_mask : _GEN_0 ? 12'h0 : _mshrs_io_replay_bits_uop_br_mask;	// @[Decoupled.scala:51:35, dcache.scala:434:21, :569:27, :583:21, :584:21, :585:21, :587:21]
  ...
  always @(posedge clock) begin
    if (_T_7) begin	// @[Decoupled.scala:51:35]
      ...
      if (_GEN_0) begin	// @[dcache.scala:584:21, :585:21, :587:21]
        ...
        s1_req_0_uop_rob_idx <= 6'h0;	// @[dcache.scala:574:{43,74}, :601:32]
      ...
      if (wb_fire) begin	// @[dcache.scala:532:38]
        ...
        s1_req_0_addr <= {8'h0, _prober_io_meta_read_bits_tag, _prober_io_meta_read_bits_idx, 6'h0};	// @[dcache.scala:433:22, :557:26, :574:{43,74}, :601:32, :659:35]
        s1_type <= 3'h1;	// @[dcache.scala:591:21, :616:32]
      end
      else if (_s0_type_T_1) begin	// @[Decoupled.scala:51:35]
        s1_req_0_addr <= {8'h0, _mshrs_io_meta_read_bits_tag, _mshrs_io_meta_read_bits_idx, 6'h0};	// @[dcache.scala:434:21, :521:29, :574:{43,74}, :601:32, :659:35]
    ...
    if (reset) begin
      ...
      if (idle & auto_out_c_ready) begin	// @[Arbiter.scala:88:28, :89:24]
        ...
        beatsLeft <= beatsLeft - {8'h0, auto_out_c_ready & out_2_valid};	// @[Arbiter.scala:87:30, :113:52, :125:29, ReadyValidCancel.scala:49:33, dcache.scala:659:35]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        beatsLeft = _RANDOM_41[20:12];	// @[Arbiter.scala:87:30]
        state_0 = _RANDOM_41[21];	// @[Arbiter.scala:87:30, :116:26]
        state_1 = _RANDOM_41[22];	// @[Arbiter.scala:87:30, :116:26]
        io_lsu_perf_release_counter = _RANDOM_41[31:23];	// @[Arbiter.scala:87:30, Edges.scala:228:27]
        io_lsu_perf_acquire_counter = _RANDOM_42[8:0];	// @[Edges.scala:228:27]
  ...
  assign auto_out_c_bits_source = {muxStateEarly_0, 1'h0} | (muxStateEarly_1 ? _prober_io_rep_bits_source : 2'h0);	// @[Arbiter.scala:117:30, Mux.scala:27:73, dcache.scala:433:22, :569:27]
  ...
  assign auto_out_c_bits_data = muxStateEarly_0 ? _wb_io_release_bits_data : 64'h0;	// @[Arbiter.scala:117:30, Mux.scala:27:73, ReadyValidCancel.scala:68:19, dcache.scala:432:18]
