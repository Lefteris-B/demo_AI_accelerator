...
module MSHR(
  ...
  wire        req_clientBit = request_source[5:2] == 4'h8 & request_source[1:0] != 2'h3;	// @[MSHR.scala:96:20, :113:22, Parameters.scala:52:64, :54:{10,32}, :56:50, :57:20]
  ...
  wire        _final_meta_writeback_clients_T_7 = meta_clients & ~((request_param == 3'h1 | request_param == 3'h2 | request_param == 3'h5) & req_clientBit);	// @[MSHR.scala:96:20, :98:17, :224:{50,52,56}, Parameters.scala:56:50, :267:13, :279:{11,43,66,75}]
  ...
  wire        _final_meta_writeback_clients_T_14 = meta_hit & meta_clients & ~probes_toN | req_acquire & req_clientBit;	// @[MSHR.scala:98:17, :149:23, :217:53, :243:{40,66,88}, :244:40, Parameters.scala:56:50]
  ...
  wire        excluded_client = meta_hit & request_prio_0 & (_excluded_client_T_1 | (&request_opcode) | request_opcode == 3'h4) & req_clientBit;	// @[MSHR.scala:96:20, :98:17, :277:28, Parameters.scala:56:50, :268:{14,52}, :276:{77,87}]
  ...
  wire [5:0]  new_request_source = io_allocate_valid ? io_allocate_bits_source : request_source;	// @[MSHR.scala:96:20, :504:24]
  ...
  wire        new_clientBit = new_request_source[5:2] == 4'h8 & new_request_source[1:0] != 2'h3;	// @[MSHR.scala:113:22, :504:24, Parameters.scala:52:64, :54:{10,32}, :56:50, :57:20]
  ...
  wire        _T_550 = new_meta_hit & (new_needT | new_meta_state == 2'h2) & new_meta_clients & ~((_T_551 | (&new_request_opcode) | new_request_opcode == 3'h4) & new_clientBit);	// @[MSHR.scala:109:22, :503:21, :504:24, :507:26, :625:{24,42,53}, :626:33, Parameters.scala:56:50, :267:70, :268:{14,52}, :276:{77,87}]
  ...
  wire        probe_bit = io_sinkc_bits_source[5:2] == 4'h8 & io_sinkc_bits_source[1:0] != 2'h3;	// @[MSHR.scala:113:22, Parameters.scala:52:64, :54:{10,32}, :56:50, :57:20]
  ...
  wire        last_probe = (probes_done | probe_bit) == (meta_clients & ~excluded_client);	// @[MSHR.scala:98:17, :148:24, :277:28, :287:53, :457:{33,46,64}, Parameters.scala:56:50]
  ...
  always @(posedge clock) begin
    ...
    probes_done <= ~_T_510 & (io_sinkc_valid & probe_bit | probes_done);	// @[MSHR.scala:98:17, :148:24, :459:49, :465:17, :537:{28,79}, :539:10, :540:17, Parameters.scala:56:50]
    probes_toN <= ~_T_510 & (io_sinkc_valid & (io_sinkc_bits_param == 3'h1 | io_sinkc_bits_param == 3'h2 | io_sinkc_bits_param == 3'h5) & probe_bit | probes_toN);	// @[MSHR.scala:98:17, :149:23, :459:49, :466:16, :537:{28,79}, :539:10, :541:16, Parameters.scala:56:50, :267:13, :279:{11,43,66,75}]
  end // always @(posedge)
  `ifndef SYNTHESIS
    ...
    wire  [3:0][3:0] _GEN_15 = {{{2'h1, ~meta_clients, ~meta_dirty}}, {{3'h1, ~meta_dirty}}, {{3'h0, ~meta_clients}}, {4'h8}};	// @[MSHR.scala:98:17, :106:22, :110:14, :219:81, :289:53, :297:69, :315:26, :316:26, :317:{26,32}, :318:26, Parameters.scala:54:32, :279:11]
    wire  [3:0]      before_0 = meta_hit ? _GEN_15[meta_state] : 4'h8;	// @[MSHR.scala:98:17, :219:81, :289:53, :315:26, :316:26, :317:26, :318:26, :321:{17,23}, Parameters.scala:54:32]
    wire  [3:0][3:0] _GEN_16 = {{{2'h1, ~_io_schedule_bits_dir_bits_data_WIRE_clients, ~_io_schedule_bits_dir_bits_data_WIRE_dirty}}, {{3'h1, ~_io_schedule_bits_dir_bits_data_WIRE_dirty}}, {{3'h0, ~_io_schedule_bits_dir_bits_data_WIRE_clients}}, {4'h8}};	// @[MSHR.scala:106:22, :221:54, :249:20, :250:21, :297:69, :315:26, :316:{26,32}, :317:{26,32}, :318:26, Parameters.scala:54:32, :279:11]
    ...
    wire             _T_107 = before_0 == 4'h8;	// @[MSHR.scala:315:26, :321:{17,23}, :373:15, Parameters.scala:54:32]
    ...
    wire             _T_423 = after == 4'h8;	// @[MSHR.scala:315:26, :316:26, :382:15, Parameters.scala:54:32]
