...
module SinkC(
  ...
  always @(posedge clock) begin
    ...
    if (_c_io_deq_valid) begin	// @[Decoupled.scala:375:21]
      ...
      bs_adr_bits_beat_r <= beat + {2'h0, _io_bs_adr_q_io_enq_ready};	// @[Decoupled.scala:375:21, Edges.scala:233:25, Reg.scala:19:16, SinkC.scala:97:59, :110:24]
    end
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        lists = _RANDOM_2[18:17];	// @[Reg.scala:19:16, SinkC.scala:110:24]
