...
module TLMonitor_17(
  ...
  reg  [327:0] inflight_sizes;	// @[Monitor.scala:615:33]
  ...
  wire         _T_1333 = _T_1409 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:652:27]
  ...
  wire [515:0] _a_sizes_set_T_1 = {511'h0, _T_1333 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {507'h0, io_in_a_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  wire         _T_1482 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire         _T_1348 = _T_1482 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:230:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      a_first_counter <= 9'h0;	// @[Edges.scala:228:27]
      d_first_counter <= 9'h0;	// @[Edges.scala:228:27]
      inflight <= 41'h0;	// @[Monitor.scala:611:27, :723:35]
      inflight_opcodes <= 164'h0;	// @[Monitor.scala:613:35, :724:35]
      inflight_sizes <= 328'h0;	// @[Monitor.scala:615:33, :725:35]
      ...
      inflight <= (inflight | (_T_1333 ? _a_set_T[40:0] : 41'h0)) & ~(_T_1348 ? _d_clr_T[40:0] : 41'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_1333 ? _a_opcodes_set_T_1[163:0] : 164'h0)) & ~(_T_1348 ? _d_opcodes_clr_T_5[163:0] : 164'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :724:35]
      inflight_sizes <= (inflight_sizes | (_T_1333 ? _a_sizes_set_T_1[327:0] : 328'h0)) & ~(_T_1348 ? _d_sizes_clr_T_5[327:0] : 328'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
      if (_T_1409 | _T_1482)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26]
    end
    if (_T_1409 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:396:20]
    ...
    if (_T_1482 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:228:27, :230:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _source_ok_WIRE_2 = io_in_a_bits_source == 6'h23;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_3 = io_in_a_bits_source == 6'h24;	// @[Parameters.scala:46:9]
    wire             source_ok = _source_ok_WIRE_0 | io_in_a_bits_source[5:2] == 4'h8 & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | io_in_a_bits_source[5:4] == 2'h1 | ~(|(io_in_a_bits_source[5:4]));	// @[Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :1125:46]
    ...
    wire             source_ok_1 = io_in_d_bits_source == 6'h28 | io_in_d_bits_source[5:2] == 4'h8 & io_in_d_bits_source[1:0] != 2'h3 | io_in_d_bits_source == 6'h23 | io_in_d_bits_source == 6'h24 | io_in_d_bits_source[5:4] == 2'h1 | io_in_d_bits_source[5:4] == 2'h0;	// @[Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :1125:46]
    ...
    wire             _T_1278 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:389:19]
    wire             _T_1302 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:228:27, :230:25, Monitor.scala:541:19]
    wire  [163:0]    _a_opcode_lookup_T_1 = inflight_opcodes >> {156'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:613:35, :634:44, Parameters.scala:54:32]
    wire  [327:0]    _GEN_26 = {319'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:638:40]
    ...
    wire  [40:0]     a_set_wo_ready = _same_cycle_resp_T_1 ? _a_set_wo_ready_T[40:0] : 41'h0;	// @[Monitor.scala:624:34, :648:{26,71}, :649:22, :723:35, OneHot.scala:57:35]
    wire             _T_1381 = io_in_d_valid & d_first_1;	// @[Edges.scala:230:25, Monitor.scala:671:26]
    ...
    wire  [40:0]     _GEN_27 = {35'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    wire             _GEN_28 = _T_1352 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_29 = _T_1352 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire  [7:0]      _GEN_30 = {4'h0, io_in_d_bits_size};	// @[Monitor.scala:691:36, Parameters.scala:52:29]
    wire             _T_1438 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:230:25, Monitor.scala:670:46, :791:71]
    wire  [40:0]     _T_1334 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [40:0]     _T_1353 = inflight >> _GEN_27;	// @[Monitor.scala:611:27, :682:25]
    wire  [327:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_26;	// @[Monitor.scala:615:33, :638:40]
    wire  [63:0]     _d_clr_wo_ready_T = 64'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire  [40:0]     _T_1439 = 41'h0 >> _GEN_27;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [327:0]    _c_size_lookup_T_1 = 328'h0 >> _GEN_26;	// @[Monitor.scala:638:40, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~_T_453) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :81:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~(io_in_a_bits_source[5:2] == 4'h8 & io_in_a_bits_source[1:0] != 2'h3 & io_in_a_bits_size == 4'h6 & io_in_a_bits_size < 4'hD & (_GEN_7 == 18'h0 | io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_address[30:16] == 15'h1 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :92:53, :94:78, :706:27, Parameters.scala:52:64, :54:{10,32}, :57:20, :91:48, :92:42, :137:{31,45,65}, :671:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~_T_453) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(_T_515 & (_source_ok_WIRE_0 | io_in_a_bits_source[5:2] == 4'h8 & io_in_a_bits_source[1:0] != 2'h3 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | io_in_a_bits_source[5:4] == 2'h1 | ~(|(io_in_a_bits_source[5:4]))))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :52:64, :54:{10,32}, :56:50, :57:20, :92:42, :1160:30, :1161:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_1381 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:230:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_1381 & ~d_release_ack ? _d_clr_wo_ready_T[40:0] : 41'h0) | a_set_wo_ready == 41'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'A' and 'D' concurrent, despite minlatency 2 (connected at CrossingHelper.scala:30:14)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(inflight == 41'h0 | _plusarg_reader_out == 32'h0 | watchdog < _plusarg_reader_out)) begin	// @[Monitor.scala:42:11, :611:27, :706:27, :709:{26,39,47,59}, :723:35, PlusArg.scala:80:11]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_1438 & ~reset & _GEN_30 != {1'h0, _c_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:42:11, :49:11, :691:36, :747:{21,42}, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at CrossingHelper.scala:30:14)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inflight = {_RANDOM_2[31:18], _RANDOM_3[26:0]};	// @[Edges.scala:228:27, Monitor.scala:611:27]
        inflight_opcodes = {_RANDOM_3[31:27], _RANDOM_4, _RANDOM_5, _RANDOM_6, _RANDOM_7, _RANDOM_8[30:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_8[31], _RANDOM_9, _RANDOM_10, _RANDOM_11, _RANDOM_12, _RANDOM_13, _RANDOM_14, _RANDOM_15, _RANDOM_16, _RANDOM_17, _RANDOM_18, _RANDOM_19[6:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_19[15:7];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_19[24:16];	// @[Edges.scala:228:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_19[31:25], _RANDOM_20[24:0]};	// @[Monitor.scala:615:33, :706:27]
        d_first_counter_2 = _RANDOM_37[31:23];	// @[Edges.scala:228:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
