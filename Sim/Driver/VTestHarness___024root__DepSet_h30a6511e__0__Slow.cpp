...
VL_ATTR_COLD void VTestHarness___024root___initial__TOP__6(VTestHarness___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    VTestHarness___024root___initial__TOP__6\n"); );
    // Init
    ...
    if ((! VL_VALUEPLUSARGS_INI(32, VL_CVT_PACK_STR_NW(5, __Vtemp_h18c2d470__0), 
        ...
        vlSelf->TestHarness__DOT__chiptop__DOT__system__DOT__uartClockDomainWrapper__DOT__uart_0__DOT__monitor__DOT__plusarg_reader__DOT__myplus = 0U;
    }
    ...
    if ((! VL_VALUEPLUSARGS_INI(32, VL_CVT_PACK_STR_NW(5, __Vtemp_h70e5f797__0), 
                                vlSelf->TestHarness__DOT__plusarg_reader__DOT__myplus))) {
        vlSelf->TestHarness__DOT__plusarg_reader__DOT__myplus = 0U;
    }
